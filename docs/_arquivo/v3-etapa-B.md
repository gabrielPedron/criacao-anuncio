# Etapa B — Agente Criador de Ofertas EE (v3)
...
- **Se o dossiê marcar o Nubi como "desconsiderado"** (sem semânticas relacionadas ao produto): **adapte** — título e campo modelo passam a se basear nos **termos dos concorrentes + termos do próprio produto**, não em volume de busca. Não trave; siga e me sinalize.
...
- **Se Nubi desconsiderado:** montar o título a partir dos **termos dos concorrentes + termos do produto** (sinal mais fraco — recomendo que eu revise com atenção).
...
- **Campo modelo:** só em **orgânico** — keywords principais separadas por vírgula e espaço (indexa na busca). Em **catálogo**, modelo = modelo real do produto; **não** fazer stuffing. **Sem Nubi:** as keywords vêm dos concorrentes + variações do produto.
